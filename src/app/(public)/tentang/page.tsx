  ...
  return (
    <div className="min-h-screen bg-[#F8FAF9]">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {/* Profile card */}
        <div className="bg-white rounded-[32px] border border-[#E5EBE5] overflow-hidden mb-10 shadow-sm">
          <div className="bg-gradient-to-r from-[#ECFDF5] to-[#D1FAE5] p-8 flex items-center justify-center relative overflow-hidden">
          ...
          <div className="p-8 lg:p-12">
            <span className="text-[11px] sm:text-xs font-bold text-[#059669] uppercase tracking-[0.15em] bg-[#ECFDF5] px-4 py-1.5 rounded-full border border-[#D1FAE5] inline-block mb-4 shadow-sm">
              Profil Institusi
            </span>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-[#1A2E1A] font-heading">{s.name}</h2>
            <p className="mt-4 text-[#4A5D4A] leading-relaxed text-base sm:text-lg">{s.description}</p>

            <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="flex items-center gap-4 p-5 bg-[#F8FAF9] rounded-2xl border border-[#E5EBE5] hover:border-[#10B981] transition-colors">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-[#1A2E1A]">{s.head}</p>
                </div>
              </div>
              <div className="flex items-center gap-4 p-5 bg-[#F8FAF9] rounded-2xl border border-[#E5EBE5] hover:border-[#10B981] transition-colors">
                <div className="w-12 h-12 rounded-xl bg-[#ECFDF5] flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <p className="text-xs font-semibold text-[#6B7E6B] mb-1">NIP</p>
                  <p className="text-sm font-bold text-[#1A2E1A] font-mono">{s.nip}</p>
                </div>
              </div>
              <div className="flex items-center gap-4 p-5 bg-[#F8FAF9] rounded-2xl border border-[#E5EBE5] hover:border-[#10B981] transition-colors">
                <div className="w-12 h-12 rounded-xl bg-[#ECFDF5] flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <p className="text-xs font-semibold text-[#6B7E6B] mb-1">Alamat</p>
                  <p className="text-sm font-bold text-[#1A2E1A]">{s.address}</p>
                </div>
              </div>
              <div className="flex items-center gap-4 p-5 bg-[#F8FAF9] rounded-2xl border border-[#E5EBE5] hover:border-[#10B981] transition-colors">
                <div className="w-12 h-12 rounded-xl bg-[#ECFDF5] flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <p className="text-xs font-semibold text-[#6B7E6B] mb-1">WhatsApp</p>
                  <p className="text-sm font-bold text-[#1A2E1A]">{s.whatsapp}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white rounded-[24px] border border-[#E5EBE5] p-8 sm:p-10 shadow-sm relative overflow-hidden">
            ...
            <h3 className="text-xl sm:text-2xl font-extrabold text-[#1A2E1A] font-heading mb-4 relative z-10 flex items-center gap-3">
              <span className="w-2 h-8 bg-[#10B981] rounded-full block"></span>
              Visi
            </h3>
            <p className="text-base text-[#4A5D4A] leading-relaxed relative z-10">
              {s.vision || 'Informasi belum tersedia.'}
            </p>
          </div>
          <div className="bg-white rounded-[24px] border border-[#E5EBE5] p-8 sm:p-10 shadow-sm relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#F0FDF4] rounded-full blur-[60px] -translate-y-1/2 translate-x-1/2"></div>
            <h3 className="text-xl sm:text-2xl font-extrabold text-[#1A2E1A] font-heading mb-4 relative z-10 flex items-center gap-3">
            ...
            {s.mission && s.mission.length > 0 ? (
              <ol className="space-y-3 relative z-10">
                {s.mission.map((m, i) => (
                  <li key={i} className="text-base text-[#4A5D4A] flex items-start gap-3">
                    <span className="font-bold text-[#059669] bg-[#ECFDF5] w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 text-xs">{i + 1}</span>
                    <span className="leading-relaxed">{m}</span>
                  </li>
                ))}
              </ol>
            ) : (
              <p className="text-base text-[#4A5D4A] relative z-10">Informasi belum tersedia.</p>
            )}
          </div>
        </div>
        ...
        {s.officeHours && (
          <div className="mt-10 bg-gradient-to-br from-[#064E3B] to-[#022C22] text-white rounded-[24px] shadow-xl p-8 sm:p-12 relative overflow-hidden border border-[#047857]/50">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 relative z-10">
              <div className="w-20 h-20 bg-white/10 backdrop-blur-md rounded-2xl flex items-center justify-center flex-shrink-0 border border-white/20">
