...
import { Plus, Search, Trash2, CheckCircle2, XCircle, FileText, ExternalLink } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-text-primary font-heading">Kelola Peraturan</h1>
          <p className="text-sm text-text-secondary mt-1">Daftar peraturan dan regulasi KUA.</p>
        </div>
        <Link
      ...
      <div className="bg-white rounded-xl border border-border-light overflow-hidden">
        {loading ? (
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    {item.documentLink && (
                      ...
                      >
                        <ExternalLink className="w-3 h-3" /> Dokumen Link
                      </a>
                    )}
                  </div>
                </div>
          ...
          <div className="p-8 text-center text-sm text-text-tertiary">
            Belum ada peraturan yang dibuat.
          </div>
        )}
      </div>
