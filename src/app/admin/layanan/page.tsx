  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-text-primary font-heading">Kelola Layanan</h1>
          <p className="text-xs sm:text-sm text-text-secondary mt-1">Daftar semua layanan KUA yang tersedia.</p>
        </div>
        <Link
