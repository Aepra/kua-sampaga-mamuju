  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 w-full transition-all duration-300 no-print ${
        isScrolled
          ? 'bg-white/85 backdrop-blur-md shadow-sm border-b border-[#E5EBE5]/50'
          : 'bg-white/70 backdrop-blur-sm border-b border-[#E5EBE5]/30'
      }`}
    >
      <div className="w-full max-w-7xl mx-auto flex items-center justify-between h-[70px] px-4 sm:px-6 lg:px-8">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          ...
          <div className="flex flex-col justify-center">
            ...
            <span className="text-[11px] text-[#6B7E6B] font-medium leading-tight">
              Kabupaten Mamuju
            </span>
          </div>
        </Link>
            ...
            return (
              ...
              >
                ...
                <span className={`relative z-10 transition-colors duration-300 ${
                  active ? 'text-[#059669]' : 'text-[#4A5D4A] group-hover:text-[#059669]'
                }`}>
                  {link.label}
                </span>
        ...
        <div className="hidden lg:flex items-center gap-3 xl:gap-4">
          <Link
            href="/layanan"
            className="p-2.5 text-[#6B7E6B] hover:text-[#064E3B] rounded-xl hover:bg-[#ECFDF5] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xs"
          ...
          {status === 'loading' ? (
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 text-sm font-bold text-[#064E3B] bg-[#ECFDF5] hover:bg-[#D1FAE5] rounded-xl transition-all duration-300 border border-[#D1FAE5] shadow-xs"
              >
            ...
            <Link
              href="/login"
              className="flex items-center gap-2 px-5 py-2.5 text-sm font-bold text-[#064E3B] bg-[#ECFDF5] hover:bg-[#D1FAE5] rounded-xl transition-all duration-300 border border-[#D1FAE5] shadow-xs hover:-translate-y-0.5 hover:shadow-sm"
            >
        ...
        {/* MOBILE TOGGLE */}
        <button
          className="lg:hidden p-2 text-[#4A5D4A] hover:text-[#064E3B] rounded-lg hover:bg-[#ECFDF5] transition-colors"
      ...
      {/* MOBILE MENU */}
      <div
        className={`absolute top-full left-0 right-0 lg:hidden overflow-hidden transition-all duration-300 bg-white border-t border-[#E5EBE5] ${
            ...
            <Link
              ...
              className={`px-4 py-2.5 text-xs font-semibold rounded-lg transition-colors ${
                isActive(link.href)
                  ...
                  : 'text-[#4A5D4A] hover:text-[#064E3B] hover:bg-[#ECFDF5]/60'
              }`}
            >
              {link.label}
            </Link>
          ))}
          <div className="mt-2 pt-2 border-t border-[#E5EBE5] flex flex-col gap-1.5">
            <Link
              href="/layanan"
              className="flex items-center gap-2 px-4 py-2.5 text-xs font-semibold text-[#4A5D4A] hover:text-[#064E3B] rounded-lg hover:bg-[#ECFDF5]/60 transition-colors"
            >
